...
\item Von oben nach unten in Dialogfenster:
 ...
 \end{itemize}
\item für mehr Infos und Troubleshooting einen Betreuer fragen und/oder \url{http://www.makerware.com/support/makerware}
\end{itemize}
...
\item Achtung, die Firmware des Ultimaker ist nicht die Werksfirmware. Hier nicht einfach Updates einspielen! \todo{github repo für Firmware mit Config anlegen}
\end{itemize}
