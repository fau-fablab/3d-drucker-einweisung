...
Wenn du nicht weiter weißt oder dir unsicher bist, frag einen Betreuer.
 \item Verbrennungsgefahr an heißen Teilen:
  \begin{itemize}
   \item Bodenplatte des Replicators und des Ultimakers\ts2 wird knallheiß. Erst vorsichtig testen und evtl. Temperatur vorher absenken.
 ...
 \begin{itemize}
  ...
  \begin{itemize}
   \item beim Utlimaker\ts2 hinten links am Gehäuse
...
\end{itemize}
Beim Ultimaker\ts2 können die Axen nicht verfahren werden.
...
\item Achtung, die Firmware des Ultimaker Original ist nicht die Werksfirmware. Hier nicht einfach Updates einspielen! \todoUnwichtig{github repo für Firmware mit Config anlegen}
\end{itemize}
